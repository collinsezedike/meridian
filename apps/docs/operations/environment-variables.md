...
| `MERIDIAN_DEFINDEX_ADAPTER_ID`           | No           | `""`                               | Candidate DeFindex adapter contract address. Left unset, DeFindex is excluded from consideration entirely, no fallback default.                                                                                                                                                                                          |
